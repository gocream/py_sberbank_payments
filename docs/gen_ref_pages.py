...
logger = logging.getLogger("py_sberbank_payments")
...
def generate_code_section():
    ...
    # parse and register
    source_path = Path(os.environ.get("PYSP_MKDOCS_CODE_PARCE_SOURCE_PATH", "py_sberbank_payments"))
    doc_path = Path(os.environ.get("PYSP_MKDOCS_CODE_PARCE_DOCS_PATH", "reference"))
    ...
    if os.environ.get("PYSP_MKDOCS_CODE_PARCE_SHOW_NAV", "f").lower() in TRUE_CHOICES:
